...
public class SortByLow {
    ...
    public void SearchP() throws Exception {

        {
            ...
            driver.findElement(By.xpath("//*[@id=\"products\"]/div[2]/div/div[3]/div/select/option[2]")).click();
            String value1 = driver.findElement(By.xpath("//*[@id=\"products\"]/div[3]/div[1]/div/div[1]/a/div/div[2]/div[3]/span")).getText().replace(",","").replace("Rs. ","");
            String value2 = driver.findElement(By.xpath("//*[@id=\"products\"]/div[3]/div[1]/div/div[9]/a/div/div[2]/div[3]/span")).getText().replace(",","").replace("Rs. ","");
          ...
          //  System.out.println(price1);
           // System.out.println(price2);
...

            {
                ...
                FileHandler.copy(src, new File("C://MY EY//Selenium//Drivers//sortbyLow.png"));
            }
            else {
